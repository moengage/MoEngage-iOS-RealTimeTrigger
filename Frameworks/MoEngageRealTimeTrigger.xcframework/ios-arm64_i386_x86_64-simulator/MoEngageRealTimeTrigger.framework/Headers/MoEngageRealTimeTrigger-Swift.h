...
#ifndef MOENGAGEREALTIMETRIGGER_SWIFT_H
#define MOENGAGEREALTIMETRIGGER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MoEngageRealTimeTrigger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Method to initialize RealTimeTrigger
/// \param instanceID Optional Parameter indicating the MoEngage Account Identifier
///
- (void)initializeRealTimeTriggerForInstanceID:(NSString * _Nonnull)instanceID;
